  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3">
      {open && (
        <div className="animate-fade-in-up bg-[#111827] border border-white/10 rounded-2xl shadow-2xl p-4 w-64">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-2.5 bg-[#25D366] text-white rounded-xl font-black text-xs uppercase tracking-wider hover:bg-[#20ba5a] transition-all duration-300 shadow-[0_0_15px_rgba(37,211,102,0.4)]"
          >
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-[#25D366] text-white shadow-[0_0_20px_rgba(37,211,102,0.6)] flex items-center justify-center hover:bg-[#20ba5a] hover:shadow-[0_0_30px_rgba(37,211,102,0.8)] transition-all duration-300 hover:scale-110 active:scale-95 border border-white/10"
