...
export default function Navbar({ onAdminClick }: NavbarProps) {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${mobileOpen ? 'h-auto pb-4' : 'h-[125px]'} glass-navbar shadow-lg`}
        role="navigation"
        ...
        <div className="w-full px-4 sm:px-8 lg:px-16">
          <div className="flex items-center justify-between h-[125px]">
            ...
            <button
              ...
              className="flex items-center gap-4 group text-left select-none"
