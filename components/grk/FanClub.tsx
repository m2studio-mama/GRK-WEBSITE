...
const INIT: FormData = { name:'', phone:'', dob:'', district:'', city:'', email:'', photo:'', bloodGroup:'', willingToDonate: false };
                ...
                <div className="glass-card p-6 sm:p-10 rounded-2xl border border-white/8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      {/* Emergency Blood Donor Checkbox */}
                      <div className="sm:col-span-2 py-2">
                        <label className="flex items-center gap-3 text-gray-300 text-xs cursor-pointer select-none">
                          <input
                            type="checkbox"
                            name="willingToDonate"
                            checked={!!formData.willingToDonate}
                            onChange={handleInputChange}
                            className="rounded bg-black/40 border-white/10 text-[#FFD700] focus:ring-[#FFD700] w-4 h-4"
                          />
                          <span>Join Emergency Blood Donors Directory (willing to donate blood in emergency)</span>
                        </label>
                      </div>
