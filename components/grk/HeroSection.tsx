  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 text-center max-w-5xl mx-auto px-4 sm:px-6 transition-all duration-1000 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        {/* Main Heading */}
        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black text-white tracking-tight leading-none mb-4 animate-fade-in-up delay-100">
          <span className="block text-balance">GAUTHAM</span>
          <span className="block text-[#FFD700] text-glow-gold text-balance">RAM KARTHIK</span>
        </h1>

        <p className="text-gray-400 text-sm sm:text-base font-serif max-w-lg mx-auto mb-10 leading-relaxed text-balance animate-fade-in-up delay-200">
          Son of Navarasa Nayagan Karthik. Grandson of legendary R. Muthuraman. 
        ...
        {/* Counters */}
        <div ref={countersRef} className="grid grid-cols-3 gap-8 max-w-md mx-auto animate-fade-in-up delay-400">
          {[
